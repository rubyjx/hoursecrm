...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>resource/js/jquery.datepick/jquery.datepick.js"></script>
  ...
  <body>
<form action="<c:url value='customer_addCustomer?position=2'/>"  name="form1" onsubmit="return validator(this)" method="post" >
<table class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
	...
	<tr>
		...
		<td colspan="3" bgcolor="#FFFFFF"><select name="conditionId" style=" width: 145px">
			<%List <CustomerConditionInfo> conditionList =(List <CustomerConditionInfo>) request.getAttribute("conditionlist"); %>
